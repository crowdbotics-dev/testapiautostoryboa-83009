...
## Project Structure
    ...
    ├── testapiautostoryboa_83009  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_83009`
...
2. Clone this repo and `cd testapiautostoryboa_83009`
